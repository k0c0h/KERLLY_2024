...
template <typename T, typename Comparator>
void ordenarLista(ListaDoble<T>& lista, Comparator comp) {
...
template <typename T, typename Comparator>
void ordenarListaBubbleSort(ListaDoble<T>& lista,Comparator comp){
    std::vector<T> elementos;
...
template <typename T>
void ordenarListaBucket(ListaDoble<T>& lista, std::function<std::string(const T&)> getKey) {
    std::vector<T> elementos;
...
template <typename T, typename Comparator>
void ordenarListaShellSort(ListaDoble<T>& lista, Comparator comp) {
...
template <typename T, typename KeyExtractor>
void ordenarListaPorRadix(ListaDoble<T>& lista, KeyExtractor getKey) {
    std::vector<T> elementos;
