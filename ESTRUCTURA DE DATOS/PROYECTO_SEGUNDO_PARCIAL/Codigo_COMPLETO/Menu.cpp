...
void Menu::submenuBusquedas()
{
    vector<string> opcionesAutos = {
        ...
        "Buscar autos por rango de fechas",  
        "Buscar autos en un espacio por rango de fechas",
        "Buscar autos por duración de estacionamiento en una fecha",         // Opción nueva
    ...
    while (true)
    {
        ...
        { // Enter
            ...
            { 
                ...
                Validaciones<string> validador;
                fecha = validador.ingresarFecha("Ingrese la fecha de búsqueda (YYYY-MM-DD): ");
                duracionMin = validador.ingresarDuracion("Ingrese la duración mínima (HH:MM): ");
                duracionMax = validador.ingresarDuracion("Ingrese la duración máxima en (HH:MM): ");
                cout << endl;
