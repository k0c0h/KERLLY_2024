...
void HistorialEstacionamiento::mostrarAutosPorDuracionEnFecha(const string& fecha, const string& duracionMin, const string& duracionMax) const {
    ...
    cout << "Autos estacionados el " << fecha << " con duración entre " << duracionMin << " y " << duracionMax << ":\n";
    cout << "------------------------------------------------------\n";
    ...
    if (!encontrado) {
        cout << "No se encontraron autos en la fecha " << fecha << " con la duración especificada.\n";
    }
}
