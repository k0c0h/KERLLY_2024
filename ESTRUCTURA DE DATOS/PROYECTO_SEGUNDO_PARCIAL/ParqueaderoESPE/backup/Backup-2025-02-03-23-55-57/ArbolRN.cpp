...
void ArbolRN::imprimirArbolGrafico() 
{
    ...
    sf::RenderWindow window(sf::VideoMode::getDesktopMode(), "Árbol Rojo-Negro", sf::Style::Fullscreen);
    ...
    while (window.isOpen())
    {
        ...
        drawTree(window, raiz, window.getSize().x / 2, 100, window.getSize().x / 6, font);
